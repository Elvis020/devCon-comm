  ...
  <div class="editorial-page">
    <div class="editorial-wrap">
      ...
      <section class="overflow-hidden rounded-md border border-dc-border bg-dc-paper">
        ...
        <div v-if="loading" class="px-4 py-10 text-sm text-dc-gray">
          Loading audit log...
        </div>
        <div v-else-if="authMode === 'local'" class="px-4 py-10 text-sm text-dc-gray">
          Hosted Supabase auth is required before audit logs are available.
        </div>
        <div v-else-if="logs.length === 0" class="px-4 py-10 text-sm text-dc-gray">
